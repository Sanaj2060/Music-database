...
<form name="search" method="post" action="search.php" class="w3-padding w3-right">
	<input class="inputForm w3-input w3-display-position w3-padding" style="top:59px;right:50px;width: 400px;" placeholder="Search by Song Title or Artist" type="text" name="find" /> 
	<input class="inputForm w3-btn w3-white w3-padding w3-display-position" style="top:59px;right:20px;" type="submit" name="search" value="  | Search  " />
  </form>
</div>
</div>
</div>
